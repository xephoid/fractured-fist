...
export const TECHNIQUES = [
    ...
    // --- MASTERS' CIRCLE ---
    { id: 'defensive_kata', name: 'Defensive Kata', type: CARD_TYPES.TECHNIQUE, cost: 4, description: "+2 Defense,\n+1 Refine.", faction: FACTION_IDS.MASTERS_CIRCLE, effects: { defense: 2, refine: 2 } },
    { id: 'perfect_form', name: 'Perfect Form', type: CARD_TYPES.TECHNIQUE, cost: 5, description: "+1 Refine, Draw 2,\n+1 Action.", faction: FACTION_IDS.MASTERS_CIRCLE, effects: { refine: 1, draw: 2, actions: 1 } },
    ...
    { id: 'flowing_counter', name: 'Flowing Counter', type: CARD_TYPES.TECHNIQUE, cost: 5, description: "+3 Defense,\n+2 Actions.", faction: FACTION_IDS.MASTERS_CIRCLE, effects: { defense: 3, actions: 2 } },

    // --- UNCOUNTED ---
    { id: 'impose_pressure', name: 'Impose Pressure', type: CARD_TYPES.TECHNIQUE, cost: 4, description: "Draw 1, +2 Spirit,\n+1 Channel.", faction: FACTION_IDS.UNCOUNTED, effects: { draw: 1, spirit: 2, channels: 1 } },
    ...
    // --- GENERAL ---
    { id: 'reading_the_opponent', name: 'Read Opponent', type: CARD_TYPES.TECHNIQUE, cost: 4, description: "Draw 1, +2 Actions.", faction: null, effects: { draw: 1, actions: 2 } },
